var ViewModel = function() {
    ...
    self.approveChange = function(){
        var checkedValue = $(event.target).prop('checked');
        var getClickEle = $(event.target).attr('id');
        AjaxCall(changeApproved,ko.toJSON({ id: getClickEle, checkedValue: checkedValue}), "post", "json", "application/json",true).done(function (response) {
            ShowNotify(response);
        });
        return true;
    }
