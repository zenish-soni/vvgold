            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="loginAlert" class="alert alert-success alert-dismissible align-items-center" role="alert" style="display: none">
                    	...
                    	<form class="mb-3" autocomplete="off" action="javascript:;" data-bind="with:$root.loginRecord">
                            <div class="mb-3">
                                <label for="email" class="form-label">Phone Number</label>
                                <input type="number" id="email" class="form-control" placeholder="Enter your phone number" autocomplete="off" data-bind="value:$data.email" />
                            </div>

                            <div class="mb-3">
                                <label for="password" class="form-label">Password</label>
                                <input type="password" id="password" class="form-control" placeholder="Enter Password" autocomplete="off" data-bind="value:$data.password" />
                            </div>

                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="remember-me" data-bind="checked:$data.remember" />
                                    <label class="form-check-label" for="remember-me"> Remember Me</label>
                                </div>
                            </div>

                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" type="submit" data-bind="click:$root.checkLogin">Sign in</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<script type="text/javascript">
	var checkLoginURL = "{{route('manage_login')}}";
</script>
<script type="text/javascript" src="{{asset('public/js/pagejs/login.js?'.time())}}"></script>
@endsection