        ...
        <div class="table-responsive text-nowrap mt-3">
            <table class="table table-hover table-bordered">
                ...
                <tbody  class="table-border-bottom-0" data-bind="visible:$root.Records().length == 0">
                    <tr>
                        <td colspan="3" align="middle">@lang('messages.no_record_found_txt')</td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<script type="text/javascript">
    var getRecords = "{{$records}}", storeRecord="{{$storeRecord}}", destoryRecord="{{$destoryRecord}}", changeStatus="{{$changeStatus}}";
</script>
<script src="{{asset('public/js/pagejs/types/type.js?'.time())}}"></script>
@endsection