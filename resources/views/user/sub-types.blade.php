            ...
            <table class="table table-hover table-bordered">
                ...
                <tbody  class="table-border-bottom-0" data-bind="visible:$root.Records().length > 0, foreach:$root.Records">
                    <tr>
                        ...
                        <td data-bind="text:$data.parent_value"></td>
                        <td>
                            <div class="btn-group">
                ...
                <tbody  class="table-border-bottom-0" data-bind="visible:$root.Records().length == 0">
                    <tr>
                        <td colspan="4" align="middle">@lang('messages.no_record_found_txt')</td>
                    </tr>
                </tbody>
            </table>
        </div>
                ...
                <div class="row clearfix">
                    <div class="col-12 mb-3">
                        ...
                        <div class="form-group">
                            <select class="form-select" name="parent_id" data-bind="options:$root.parentArray, optionsText:'name', optionsValue:'id', value:$data.parent_id, optionsCaption:'{{$parentPlaceholder}}',decorateErrorElement:$data.parent_id"></select>
                        </div>
                    </div>
                    <div class="col-12 mb-3">
...
<script type="text/javascript">
    var getRecords = "{{$records}}", storeRecord="{{$storeRecord}}", destoryRecord="{{$destoryRecord}}", parentPlaceholder="{{$parentPlaceholder}}", parentArr=@json($parentData);
</script>
<script src="{{asset('public/js/pagejs/types/sub-type.js?'.time())}}"></script>
@endsection