            ...
            <table class="table table-hover table-bordered">
                ...
                <tbody  class="table-border-bottom-0" data-bind="visible:$root.Records().length > 0, foreach:$root.Records">
                    <tr>
                        ...
                        <td data-bind="text:$data.percentage"></td>
                        <td>
                            <div class="btn-group">
...
<div class="modal fade" id="addRecord" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <form class="modal-content" data-bind="with:$root.recordModel">
                ...
                <div class="row clearfix">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            <select class="form-select" data-bind="options:$root.percentages, value:$data.percentage, optionsCaption:'Select Percentage'"></select>
                        </div>
                    </div>
...
<script type="text/javascript">
    var getRecords = "{{$records}}", storeRecord="{{$storeRecord}}", destoryRecord="{{$destoryRecord}}", percentages=@json($percentages);
</script>
<script src="{{asset('public/js/pagejs/size.js?'.time())}}"></script>
@endsection