...
<script type="text/javascript">
    var getRecords = "{{$records}}", storeRecord="{{$storeRecord}}", destoryRecord="{{$destoryRecord}}", changeStatus="{{$changeStatus}}", parentArr=@json($parentData);
</script>
<script src="{{asset('public/js/pagejs/types/sub-image-type.js?'.time())}}"></script>
@endsection