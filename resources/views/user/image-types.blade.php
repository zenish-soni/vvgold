            ...
            <div class="modal-body">
                <div class="row clearfix">
                    ...
                    <div class="col-12 mb-3">
                        <label>Code</label>
                        <div class="form-group">
                            <input type="text" class="form-control" name="code" data-bind="value:$data.code" placeholder="Enter Code" autocomplete="off" />
                        </div>
                    </div>
                    <div class="col-12">
                        <label>Image</label>
...
<script src="{{asset('public/js/pagejs/types/image-type.js?'.time())}}"></script>
@endsection